...
const ScoreBoard = () => {
  ...
  // if no ball,wide are player get extra ball
  ...
  const handleBatter1Blur = (e) => {
    ...
    const updateBatter1 = (name) => ({
      id: name + MathUtil.getRandomNo(),
      name: name,
      run: 0,
      ball: 0,
      four: 0,
    ...
    <div className="container">
      <div className="inning">
        ...
        <div>
          <Button
            id="end-inning"
            color={inningNo === 1 ? "error" : "success"}
            variant="contained"
      ...
      <div className="score-container">
          ...
          <table>
            <thead>
              <tr>
                ...
                <td className="score-types text-left">4s</td>
                <td className="score-types text-left">6s</td>
                <td className="score-types text-left">SR</td>
              </tr>
            </thead>
            <tbody>
              <tr>
        ...
        <div className="bowler-container">
          ...
          <Divider sx={{ mt: 2 }} />
          <div
            className="bowler-runs"
            style={{
              backgroundColor:
                currentRunStack.length === 0 ? "transparent" : "#ffff4d",
            }}
          >
